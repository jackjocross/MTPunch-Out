...
public class ClockScript : MonoBehaviour {
	...
	public void nextRound() {
		...
		SaveScene.LittleMacKnockdowns = LittleMacController.LittleMac.knockdowns;
		SaveScene.Points=PointScript.PointController.getCurrentScore();
		if (MatchController.Match.roundNum == 1) {
			...
			if (Application.loadedLevelName.Equals("_Scene_Mario_Luigi")) {
				...
				SaveScene.VonKaiserKnockdowns=VonKaiserController.VonKaiserC.knockdowns;
